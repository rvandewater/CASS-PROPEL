...
DATA_PATH = Path("/sc-projects/sc-proj-cc08-cassandra/Retrospective_Dataset/0_transfer/pre_v1_emergency.csv")
VALIDATION_DATA_PATH = Path("/sc-projects/sc-proj-cc08-cassandra/Retrospective_Dataset/0_transfer/pre_v1_emergency.csv")
...
class RetroEmergPreop(Dataset):
    def __init__(self):
        super(RetroEmergPreop, self).__init__(DATA_PATH, DATA_INFOS_PATH)
